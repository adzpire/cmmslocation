...
<div class="wrap">
    ...
    NavBar::begin([
        'brandLabel' => '<img class="cmmslogo" alt="Brand" src="/media/parallax/img/commsci_logo_black.png">' . '<table class="navtablelogo"><tbody>
		  ...
		  <tr style="font-size: small;"><td>' . Yii::t('app', 'จัดการห้อง/สถานที่ คณะวิทยาการสื่อสาร') . '</td></tr>
		  </tbody></table>',
...
<footer class="footer">
    <div class="container-fluid">
        <p>© 2016 PSU YII DEV <span
            ...
            <?php echo '  ' . Yii::t('app', 'footer_problem'); ?> : <a
                href="mailto:<?php echo Yii::t('app', 'adminEmail'); ?>"><?php echo Yii::t('app', 'adminName'); ?></a><?php echo ' ' . Yii::t('app', 'adminfooterIntercom'); ?>
